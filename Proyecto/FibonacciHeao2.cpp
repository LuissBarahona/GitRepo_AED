...
class FHeap{
    ...
    void visualizar();
    void decreaseNode(Nodo<T>* nodo, T nuevo_valor);
...
int main() {
    ...
    std::cout << "Insertando elementos 10, 20, 5, 15, 30 en el heap." << std::endl;
    heap.insert(10);
    heap.insert(20);
    heap.insert(5);
    heap.insert(15);
    ...
    // Visualización después de las inserciones
    std::cout << "Visualización del heap después de las inserciones:" << std::endl;
    heap.visualizar();

    // Obtener el valor mínimo
    std::cout << "El valor mínimo es: " << heap.valor_min() << std::endl;

    // Extraer el valor mínimo
    Nodo<int>* minNode = heap.extractMin();
    std::cout << "El valor mínimo extraído es: " << minNode->data << std::endl;

    // Visualización después de extraer el mínimo
    std::cout << "Visualización del heap después de extraer el mínimo:" << std::endl;
    heap.visualizar();

    // Insertar más elementos
    std::cout << "Insertando elementos 25 y 7 en el heap." << std::endl;
    heap.insert(25);
    heap.insert(7);

    // Visualización después de nuevas inserciones
    std::cout << "Visualización del heap después de insertar 25 y 7:" << std::endl;
    heap.visualizar();

    // Disminuir el valor de un nodo
    // Nota: Necesitas guardar el puntero al nodo que deseas disminuir
    // Aquí asumimos que hemos accedido al nodo con valor 20 para disminuirlo a 3
    std::cout << "Disminuyendo el valor del nodo con 20 a 3." << std::endl;
    // Accedemos manualmente al nodo que queremos disminuir en este ejemplo
    Nodo<int>* nodoADecrementar = heap.ptr_min->derecha; // nodo con valor 20
    heap.decreaseNode(nodoADecrementar, 3);

    // Visualización después de la operación decreaseNode
    std::cout << "Visualización del heap después de decreaseNode (20 -> 3):" << std::endl;
    heap.visualizar();

    // Eliminar un nodo
    std::cout << "Eliminando el nodo con valor 15." << std::endl;
    Nodo<int>* nodoAEliminar = heap.ptr_min->derecha->derecha; // nodo con valor 15
    heap.deleteNode(nodoAEliminar);

    // Visualización después de eliminar el nodo
    std::cout << "Visualización del heap después de eliminar el nodo con valor 15:" << std::endl;
    heap.visualizar();
