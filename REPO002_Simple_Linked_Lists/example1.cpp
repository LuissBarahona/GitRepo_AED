/* DESCRIPTION
    Topic: Simple Linked Lists o Forward Lists
...
class List {
    private:
        Node* head;
    public:
        List() : head(NULL) {} // Constructor de la clase
        ...
        void insert_into_nth(int data, int n) {
            Node* new_node = new Node(data); // Crear un nuevo nodo
        ...
        void delet_nth(int n){
            Node* temp = head; //HAcer que temp apunte al nodo head 0°
            Node* temp2;
            if (n==0){
        ...
        void reverse() {
            Node* prev = NULL; // Puntero para rastrear el nodo anterior
            Node* current = head; // Puntero para rastrear el nodo actual
            Node* next = NULL; // Puntero para rastrear el siguiente nodo
        ...
        void bubble_sort() { //Ascendente
            ...
            Node* ptr1;         // Puntero que recorre la lista
            Node* lptr = NULL;  // Puntero que marca el final de la porción ordenada de la lista
